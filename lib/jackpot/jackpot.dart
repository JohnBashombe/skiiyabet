...
//   Widget myJackPotMenu(int index) {
//     return MouseRegion(
...
//           if (mounted)
//             setState(() {
//               print("Clicking on: ${_jackPotMenu[index]}");
//               currentWindow = index;
//             });
//         },
//         child: Text(
//           _jackPotMenu[index],
//           style: TextStyle(
//             color: currentWindow == index ? Colors.black87 : Colors.black87,
//             fontSize: currentWindow == index ? 14.0 : 13.0,
//             fontWeight:
//                 currentWindow == index ? FontWeight.bold : FontWeight.w300,
//             decoration: currentWindow == index
...
//             children: _jackPotMenu
//                 .asMap()
//                 .entries
//                 .map((MapEntry map) => myJackPotMenu(map.key))
//                 .toList(),
//           ),
//           SizedBox(height: 5.0),
//           Divider(
...
//           SizedBox(height: 5.0),
//           // jackPot_intro(),
//           if (currentWindow == 0) jackPot_intro(),
//           if (currentWindow == 0) jackPot_games(),
//           if (currentWindow == 1) jackPot_results(),
//           if (currentWindow == 2) jackPot_bets(),
//           if (currentWindow == 3) jackPot_help(),

//           if (_jackpotGame == null)
//             Center(child: SpinKitCircle(color: Colors.lightBlue, size: 20.0)),
//           if (currentWindow == 0) bottom_container(),
...
//                             ' ' +
//                             _jackpotGame['description']['name'].toString() +
//                             ' - ' +
...
//     // LOCAL TEAM GAME
//     var _localTeam = _jackpotGame['matches']['data'][_index]['1'];
//     // VISTOR TEAM OF GAME
//     var _visitorTeam = _jackpotGame['matches']['data'][_index]['2'];
//     // GET THE DATE TIME
